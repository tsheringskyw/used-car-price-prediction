...
PROJECT_TITLE = "Used Car Price Prediction"

STUDENT_NAME = "Tshering Wangchuk"

PROBLEM_STATEMENT = """
Can vehicle characteristics such as manufacturing year, kilometres driven,
fuel type, transmission, engine size, mileage, and ownership history
be used to predict the selling price of a used car?
"""

RESEARCH_QUESTIONS = [
    "How does vehicle age affect the selling price of used cars?",
    "How does kilometres driven relate to selling price?",
    "Do fuel type and transmission affect used-car prices?",
    "Which vehicle characteristics are most strongly associated with selling price?",
    "How accurately can machine learning predict used-car selling prices?"
]
...
EXPECTED_USERS = (
    "Used-car buyers, sellers, dealers, and automotive marketplaces."
)

EXPECTED_VALUE = (
    "The model can provide an estimated price to help users "
    "evaluate and compare used vehicles."
)

KNOWN_LIMITATIONS = (
    "Predictions depend on the quality and representativeness of the dataset "
    "and may not reflect all market conditions."
)
...
def load_default_data() -> Tuple[pd.DataFrame, str]:
    """
    Load the actual used-car dataset stored in the GitHub project.
    """
    try:
        df = pd.read_csv("Car details v3.csv")
        return df, "Car details v3.csv"
    except Exception as exc:
        raise FileNotFoundError(
            f"Could not load Car details v3.csv: {exc}"
        )
